...
$sql = "SELECT user_id FROM forgotpassword WHERE rkey='$key' AND user_id='$user_id' AND mytime > '$time' AND status='pending'";
...
if(!$result){
    ...
    echo '<div class="alert alert-success">Your password has been update successfully!<a href="main.php">Login</a></div>';  
}
?>